package com.poldroc.rpc.framework.core.serialize.rpc;



import com.poldroc.rpc.framework.core.serialize.SerializeFactory;
import com.poldroc.rpc.framework.core.serialize.User;
...
public class RpcSerializeFactory implements SerializeFactory {
    ...
    public static void main(String[] args) {
        RpcSerializeFactory serializeFactory = new RpcSerializeFactory();
        User user = new User();
        user.setId(11);
        user.setTel(12L);
